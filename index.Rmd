...
### 简介 {-#intro}
本书为R和tidyverse的入门向教程。教学视频在b站（还没开播，从6月中旬一直跳票到8月初）。附加资源在[R-Tutorial-Resources Github仓库](https://github.com/TianyiShi2001/R-Tutorial-Resorces)。
...
3. **SAS, SPSS, STATA等软件**。它们是资本主义的邪恶产物。
