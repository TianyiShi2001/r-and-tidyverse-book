...
\addcontentsline{toc}{subsection}{为什么写本书}
...
\addcontentsline{toc}{subsection}{关于编写本书的技术信息}
...
\includegraphics{R与tidyverse——数据分析入门_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\includegraphics{R与tidyverse——数据分析入门_files/figure-latex/unnamed-chunk-43-1.pdf}
...
\includegraphics{R与tidyverse——数据分析入门_files/figure-latex/unnamed-chunk-95-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{h <-}\StringTok{ }\NormalTok{women1}\OperatorTok{$}\NormalTok{height_in_m}
\NormalTok{women2 <-}\StringTok{ }\KeywordTok{mutate}\NormalTok{(women, }
                 \DataTypeTok{height_in_m =}\NormalTok{ h, }\CommentTok{# 引用外部vector}
                 \DataTypeTok{weight_in_kg =}\NormalTok{ women1}\OperatorTok{$}\NormalTok{weight_in_kg) }\CommentTok{# 引用`women1`里的数据}
\KeywordTok{identical}\NormalTok{(women2 ,women1) }\CommentTok{# 和`women1`是相同的}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{aids_span3 <-}\StringTok{ }\NormalTok{aids }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(status }\OperatorTok{==}\StringTok{ "D"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(diag, death) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{span =}\NormalTok{ death}\OperatorTok{-}\NormalTok{diag)}
\CommentTok{# 验证和方法二的结果一致（即和方法一一致）}
\KeywordTok{identical}\NormalTok{(aids_span2, aids_span3)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{R与tidyverse——数据分析入门_files/figure-latex/unnamed-chunk-206-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mpg_summary <-}\StringTok{ }\NormalTok{mpg }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(manufacturer) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{cty_mean =} \KeywordTok{mean}\NormalTok{(cty),}
            \DataTypeTok{cty_SE =} \KeywordTok{sd}\NormalTok{(cty)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n),}
            \DataTypeTok{hwy_mean =} \KeywordTok{mean}\NormalTok{(hwy),}
            \DataTypeTok{hwy_SE =} \KeywordTok{sd}\NormalTok{(hwy)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n))}
...
\includegraphics{R与tidyverse——数据分析入门_files/figure-latex/unnamed-chunk-209-1.pdf}
